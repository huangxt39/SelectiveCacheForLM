...
data_path = f'./LMdatasets/processed-{tokenizer_name}-{batch_size}-{block_size}-fix12'
if os.path.exists(data_path) and not args.regen_data:
    print('loading dataset...')
    tokenized_dataset = load_from_disk(data_path)
else:
    tokenized_dataset = process_pg19(batch_size, block_size, tokenizer, work_dir='./LMdatasets')
